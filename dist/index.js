...
exports.replaceUnderscore = exports.buildSiteNode = exports.buildFolderTree = void 0;
const fs = __importStar(__webpack_require__(747));
const YAML = __importStar(__webpack_require__(552));
/**
 ...
 */
function buildSiteNode(folderTreeNode, siteNode) {
...
exports.buildSiteNode = buildSiteNode;
/**
 *
 * @param {string} text
 */
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.verifySpaces = void 0;
const fs = __importStar(__webpack_require__(747));
const path = __importStar(__webpack_require__(622));
function verifySpaces(localDirectory) {
    const directories = getDirectoriesRecursive(localDirectory).filter(c => /\s/.test(c));
    if (typeof directories !== 'undefined' && directories.length > 0) {
        throw new Error(`Directory ${directories[0]} contains spaces. Please replace spaces with "_"(underscore)`);
    }
}
exports.verifySpaces = verifySpaces;
...
var PlainValue = __webpack_require__(215);
var resolveSeq = __webpack_require__(140);
var Schema = __webpack_require__(656);
...
var PlainValue = __webpack_require__(215);
var resolveSeq = __webpack_require__(140);
var warnings = __webpack_require__(383);
...
var Document$1 = __webpack_require__(983);
var Schema = __webpack_require__(656);
var warnings = __webpack_require__(383);
